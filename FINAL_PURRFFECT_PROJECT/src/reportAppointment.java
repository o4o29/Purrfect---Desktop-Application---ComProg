...
public class reportAppointment extends JFrame {
	...
	private void initialize() {
		...
		title_1.setBounds(303, -17, 262, 100);
		...
		lblNewLabel_1_1.setBounds(199, 55, 479, 40);
		getContentPane().add(lblNewLabel_1_1);
		
		JLabel lblNewLabel_1_1_1 = new JLabel("Appointment Report");
		...
		lblNewLabel_1_1_1.setBounds(326, 117, 213, 40);
		...
		print_BTN.setBounds(393, 527, 106, 23);
		getContentPane().add(print_BTN);
		
		JScrollPane scrollPane = new JScrollPane(table, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED, JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
		scrollPane.setBounds(10, 156, 864, 360);
	...
	public void populateTable() {
        try {
            ...
            ResultSet resultSet = dbManager.getAllAppointments();
            while (resultSet.next()) {
                ...
                row.add("₱" + resultSet.getInt("payment"));
	...
	public void createPDF() throws DocumentException, IOException {
	    ...
	    File file = new File("AppointmentInformationReport.pdf");
	    PdfWriter.getInstance(document, new FileOutputStream(file));
	    document.open();

	    // title
	    document.add(new Paragraph("Appointment Information Report", FontFactory.getFont(FontFactory.HELVETICA_BOLD, 18, new com.itextpdf.text.BaseColor(255, 0, 0))));
