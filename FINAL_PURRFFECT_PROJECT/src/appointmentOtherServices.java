...
public class appointmentOtherServices extends JFrame {
	...
	public static void getAppointmentInformation(int petId, String petName, int clientId, String clientName, List<Integer> selectedServiceIds, Date apptDate, Time apptTime) {
		...
		appointmentOtherServices.clientName = clientName;
		appointmentOtherServices.date = apptDate;
		appointmentOtherServices.time = apptTime;
	...
	private void initialize() {
		...
		saveAppointment_Btn.addActionListener(e -> { // SAVE THE APPOINTMENT
	        ...
	        if (selectedServiceIds.isEmpty()) {
				JOptionPane.showMessageDialog(null, "Please select a service before proceeding.", "No Service Selected", JOptionPane.WARNING_MESSAGE);
				return;
			}
	        ...
	        try {
	            ...
	            int appointID = dbManager.insertAppointment(clientId, petId, selectedServiceIds, date, time, totalPrice, petName, clientName);
